...
library(leaflet.extras) # more leaflet extras
...
## REMINDER: if you add a new .Renviron file, or if you update it, RESTART THE R SESSION for your changes to take effect ;)
